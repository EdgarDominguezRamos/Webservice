...
class Edit:
    ...
    def POST_EDIT(id_comentario, **k):
        ...
        result = config.model.edit_comentarios(
            form['id_comentario'],form['id_post'],form['id_aluminio_post'],form['id_pet_post'],form['id_carton_post'],form['fecha_comentario'],form['comentario'],form['categoria'],form['id_usuario_eco'],
        )
